...
This repository contains the **Crypto Signal System v2** - a production trading system for Raspberry Pi. This document explains how to set up, collaborate, and maintain the system.
